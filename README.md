...
Marvin Kiene, Eva Vizsolyi Cseperke, Martin Löder and Christian Laforsch (2024). evalPurency: Automated Evaluation of Data of the Purency's Microplastic Finder. R package version 1.3.7.9020.
...
A BibTeX-entry for LaTeX-user is
  ...
  @Misc{,
    ...
    note = {R package version 1.3.7.9020},
    year = {2024},
